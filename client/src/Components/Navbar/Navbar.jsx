...
function Navbar() {
    ...
    return (
        <div className='sm:h-[2rem] sticky top-0 z-50'>
            ...
            <div className={!nav ? 'text-white  fixed sm:left-0 sm:top-0 sm:w-[60%] sm:h-[15rem] sm:border-r border-r-gray-800 ease-in-out duration-200 sm:visible md:invisible ' : 'fixed left-[-100%]'}>
            ...
            <ul className=' sm:invisible md:visible lg:mt-[-2rem] lg:gap-[5rem] font-bold font-serif text-white cursor-pointer flex justify-center '>
                <li className='hover:text-blue-500'>Home</li>
                <li className='hover:text-blue-500'>Menu</li>
                <li className='hover:text-blue-500'>Service</li>
                <li className='hover:text-blue-500'>About</li>
            </ul>
            <ul className='sm:invisible md:visible lg:mt-[-1.5rem] lg:mr-[2rem] lg:gap-[3rem] text-white flex justify-end'>
