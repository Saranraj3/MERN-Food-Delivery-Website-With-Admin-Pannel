...
function Footer() {
    return (
        <div className='sm:mt-[4rem] md:mt-[8rem]' id='about'>
            <div>
                ...
                <div className='sm:mt-5 sm:text-center md:mt-[2rem] md:text-left xl:text-center xl:mr-[35rem] text-white ml-5 font-bold '>
